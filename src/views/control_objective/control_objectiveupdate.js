...
function Control_Objective_Update(){
  ...
  let postData=()=>{
    if (postData.length) {
      ...
      return;
        ...
        axios.put(API_URL+`/controlobjective/${params.id}/`,{
          title:'test',
      ...
      async function Control_data(){
        let result=await fetch(API_URL+`/controlobjective/${params.id}/`);
            ...
            <div className="mb-3">
              ...
              <div className="mb-3">
                <CCol xs="auto">
                  ...
                  <CFormSelect value={Category} onChange={handlecategory} aria-label="Default select example" >
...
export default Control_Objective_Update
