...
//     label: "Update",
//     icon: "pi pi-refresh",
//     command: (e) =>  navigate(`/Risk_Repositryupdate/${data.id}/` )
//   },
//   {
//     label: "View",
//     icon: "pi pi-refresh",
//     command: (e) =>  navigate(`/Risk_Repositryview/${data.id}/` )
//   },
//   {
//     label: "Delete",
//     icon: "pi pi-times",
...
const handleClick = (event) => {
  ...
  navigate(`/Risk_Repositryupdate/${clickedRowId}/`);
}


let get_data=(search = "")=>{ 
  let api = new RiskrepositoryService;
  api.getAllRisks(search).then((res) => { setDataTableList(res.data); }).catch((err) => { });
}
      ...
      <CCol className="" xs={12}> 
        ...
        <CCard className="p-3">      
          <CCardHeader className='text-center'>
                <h3 style={{fontWeight:400}}>Risk Repository</h3>           
          </CCardHeader>
        </CCard>
        ...
        <CCard className="mb-4">
          <CCardBody>
            ...
            rowsPerPageOptions={[10,20,50]}>
              ...
              <Column style={{cursor:'pointer'}} field="department_id" header="Department" body={DepartmentService.getName} ></Column>   
...
export default Risk_Repository
